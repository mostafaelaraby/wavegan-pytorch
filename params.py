...
beta1 = 0.5
beta2 = 0.999
decay_lr = True # used to linearly deay learning rate untill reaching 0 at iteration 100,000
...
model_capacity_size = 64    # model capacity during training can be reduced to 32 for larger window length of 2 seconds and 4 seconds
# rate of storing validation and costs params
store_cost_every = 300
progress_bar_step_iter_size = 200
#############################
# Backup Params
#############################
take_backup = True
